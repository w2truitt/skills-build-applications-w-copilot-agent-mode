...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create users - Mergington High School students with superhero-themed usernames
        users = [
        ...
        # Create teams - Mergington Physical Education teams
        ...
        # Add all users to Gold Team (last team created)
        for user in users:
            gold_team.members.add(user)
        
        self.stdout.write(self.style.SUCCESS('Created Blue Team and Gold Team'))

        # Create activities with various fitness activities
        activities = [
        ...
        # Create workouts - Fixed syntax error from original
        workouts = [
        ...
        self.stdout.write(self.style.SUCCESS('Successfully populated the database with test data for Mergington High School OctoFit Tracker!'))
